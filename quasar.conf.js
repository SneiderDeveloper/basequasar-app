  ...
  return {
    ...
    pwa: {
      ...
      manifest: {
        ...
        icons: [
          {
            'src': 'statics/icons/icon-128x128.jpg',
            'sizes': '128x128',
            'type': 'image/png'
          },
          {
            'src': 'statics/icons/icon-192x192.jpg',
            'sizes': '192x192',
            'type': 'image/png'
          },
          {
            'src': 'statics/icons/icon-256x256.jpg',
            'sizes': '256x256',
            'type': 'image/png'
          },
          {
            'src': 'statics/icons/icon-384x384.jpg',
            'sizes': '384x384',
            'type': 'image/png'
          },
          {
            'src': 'statics/icons/icon-512x512.jpg',
            'sizes': '512x512',
            'type': 'image/png'
          }
        ],
